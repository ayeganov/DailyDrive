...
from models import ChoreTable, WeekScores, Chore, ChoreHistory, get_current_week_start, utcnow
...
async def archive_and_reset_user_chores(
    ...
    reset_statuses = {
        "Monday": "_", "Tuesday": "_", "Wednesday": "_",
        "Thursday": "_", "Friday": "_", "Saturday": "_", "Sunday": "_"
    }
